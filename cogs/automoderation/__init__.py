...
class AutoModeration(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.guild_id = 1199287508794626078  # Target Guild ID
        self.admin_channel_id = 1308737327258140712

        # ID of the user to receive DM logs
        self.log_user_id = 524674960153903126
...
class ModerationView(discord.ui.View):
    def __init__(self, bot, message: discord.Message, admin_channel: discord.abc.GuildChannel):
        ...
        # ID of the user to receive DM logs
        self.log_user_id = 1136590782183264308
