...
class HorrorRaid(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.raid_channel_ids = [1404885707788648448]
    ...
    async def chaosspawn(self, ctx, boss_hp: IntGreaterThan(0)):
        ...
        try:
            ...
            channels = [
                self.bot.get_channel(1404885707788648448)
...
""",
            ...
            # Main battle loop.
            while boss_hp > 0 and len(raid) > 0 and datetime.datetime.now(timezone.utc) < start + datetime.timedelta(minutes=45):
