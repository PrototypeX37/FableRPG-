...
class AmuletTypeView(ui.View):
    ...
    def create_tier_embed(self):
        ...
        type_emoji = {
            "balanced": "<:balancedamulet:1405960167048085676>",
            "attack": "<:attackamulet:1405960152200384562>", 
            "defense": "<:defenseamulet:1405960204335448204>",
            "health": "<:healthamulet:1405960435550916669>"
        }
...
class AmuletCrafting(commands.Cog):
    ...
    async def amulet_help(self, ctx):
        ...
        # Amulet types
        amulet_types = (
            f"<:balancedamulet:1405960167048085676> **Balanced** - Equal HP, Attack, Defense bonuses\n"
            f"<:attackamulet:1405960152200384562> **Attack** - High Attack, moderate HP/Defense\n"
            f"<:defenseamulet:1405960204335448204> **Defense** - High Defense, moderate HP/Attack\n"
            f"<:healthamulet:1405960435550916669> **Health** - High HP, moderate Attack/Defense"
        )
