...
class SPGame:
    ...
    async def _day_phase(self, day_no: int, deaths=None):
        ...
        try:
            ...
            discussion_end = datetime.datetime.now(timezone.utc) + datetime.timedelta(seconds=45)
            ...
            next_speaker_idx = 0
            next_speaker_time = datetime.datetime.now(timezone.utc) + datetime.timedelta(seconds=self.rnd.uniform(3.0, 5.0))
            ...
            while datetime.datetime.now(timezone.utc) < discussion_end:
                ...
                if datetime.datetime.now(timezone.utc) >= next_speaker_time and next_speaker_idx < len(speakers):
                    ...
                    # Set up next speaker
                    next_speaker_idx += 1
                    next_speaker_time = datetime.datetime.now(timezone.utc) + datetime.timedelta(seconds=self.rnd.uniform(4.0, 7.0))
        ...
        voting_end = datetime.datetime.now(timezone.utc) + datetime.timedelta(seconds=30)
        ...
        while datetime.datetime.now(timezone.utc) < voting_end and not has_human_voted:
